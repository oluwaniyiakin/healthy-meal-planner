...
},{}],"../node_modules/@firebase/auth/dist/esm2017/index-dfc2d82f.js":[function(require,module,exports) {
var define;
"use strict";
 ...
 * @public
 */
var debugErrorMap = exports.G = _debugErrorMap;
/**
 ...
 * @public
 */
var prodErrorMap = exports.H = _prodErrorMap;
 ...
 * @public
 */
var AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY = exports.I = {
 ...
 * limitations under the License.
 */
var FetchProvider = exports.aP = /*#__PURE__*/function () {
...
function _performApiRequest2() {
  _performApiRequest2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee104(auth, method, path, request) {
    var customErrorMap,
      _args104 = arguments;
    return _regeneratorRuntime().wrap(function _callee104$(_context104) {
      while (1) switch (_context104.prev = _context104.next) {
        case 0:
          customErrorMap = _args104.length > 4 && _args104[4] !== undefined ? _args104[4] : {};
          return _context104.abrupt("return", _performFetchWithErrorHandling(auth, customErrorMap, /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee103() {
            ...
            return _regeneratorRuntime().wrap(function _callee103$(_context103) {
              while (1) switch (_context103.prev = _context103.next) {
                ...
                case 6:
                  ...
                  return _context103.abrupt("return", FetchProvider.fetch()(_getFinalTarget(auth, auth.config.apiHost, path, query), fetchArgs));
                case 12:
                case "end":
...
function _performFetchWithErrorHandling2() {
  _performFetchWithErrorHandling2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee105(auth, customErrorMap, fetchFn) {
    ...
    return _regeneratorRuntime().wrap(function _callee105$(_context105) {
      while (1) switch (_context105.prev = _context105.next) {
        ...
        case 13:
          ...
          return _context105.abrupt("return", json);
        case 17:
        ...
        case 37:
          _context105.prev = 37;
          _context105.t0 = _context105["catch"](2);
          if (!(_context105.t0 instanceof _util.FirebaseError)) {
            _context105.next = 41;
            break;
          }
        ...
        case 41:
          ...
          _fail(auth, "network-request-failed" /* AuthErrorCode.NETWORK_REQUEST_FAILED */, {
            'message': String(_context105.t0)
          });
        case 42:
        case "end":
          return _context105.stop();
      }
    }, _callee105, null, [[2, 37]]);
  }));
  return _performFetchWithErrorHandling2.apply(this, arguments);
}
...
function _performSignInRequest2() {
  _performSignInRequest2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee106(auth, method, path, request) {
    var customErrorMap,
      serverResponse,
      _args106 = arguments;
    return _regeneratorRuntime().wrap(function _callee106$(_context106) {
      while (1) switch (_context106.prev = _context106.next) {
        ...
        case 3:
          serverResponse = _context106.sent;
          if ('mfaPendingCredential' in serverResponse) {
            _fail(auth, "multi-factor-auth-required" /* AuthErrorCode.MFA_REQUIRED */, {
              _serverResponse: serverResponse
            });
          }
          return _context106.abrupt("return", serverResponse);
        case 6:
        case "end":
...
function _getRecaptchaParams() {
  _getRecaptchaParams = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee107(auth) {
    return _regeneratorRuntime().wrap(function _callee107$(_context107) {
      while (1) switch (_context107.prev = _context107.next) {
        ...
        case 2:
          _context107.t0 = _context107.sent.recaptchaSiteKey;
          if (_context107.t0) {
            _context107.next = 5;
            break;
          }
...
function _getRecaptchaConfig() {
  _getRecaptchaConfig = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee108(auth, request) {
    return _regeneratorRuntime().wrap(function _callee108$(_context108) {
      while (1) switch (_context108.prev = _context108.next) {
        case 0:
          return _context108.abrupt("return", _performApiRequest(auth, "GET" /* HttpMethod.GET */, "/v2/recaptchaConfig" /* Endpoint.GET_RECAPTCHA_CONFIG */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function _deleteAccount() {
  _deleteAccount = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee109(auth, request) {
    return _regeneratorRuntime().wrap(function _callee109$(_context109) {
      while (1) switch (_context109.prev = _context109.next) {
        case 0:
          return _context109.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:delete" /* Endpoint.DELETE_ACCOUNT */, request));
        case 1:
        case "end":
...
function _deleteLinkedAccounts() {
  _deleteLinkedAccounts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee110(auth, request) {
    return _regeneratorRuntime().wrap(function _callee110$(_context110) {
      while (1) switch (_context110.prev = _context110.next) {
        case 0:
          return _context110.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:update" /* Endpoint.SET_ACCOUNT_INFO */, request));
        case 1:
        case "end":
...
function _getAccountInfo() {
  _getAccountInfo = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee111(auth, request) {
    return _regeneratorRuntime().wrap(function _callee111$(_context111) {
      while (1) switch (_context111.prev = _context111.next) {
        case 0:
          return _context111.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:lookup" /* Endpoint.GET_ACCOUNT_INFO */, request));
        case 1:
        case "end":
...
function _getIdTokenResult() {
  _getIdTokenResult = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee112(user) {
    var forceRefresh,
      userInternal,
      token,
      claims,
    ...
    return _regeneratorRuntime().wrap(function _callee112$(_context112) {
      while (1) switch (_context112.prev = _context112.next) {
        case 0:
          forceRefresh = _args112.length > 1 && _args112[1] !== undefined ? _args112[1] : false;
          userInternal = (0, _util.getModularInstance)(user);
          _context112.next = 4;
          return userInternal.getIdToken(forceRefresh);
        case 4:
          token = _context112.sent;
...
function _logoutIfInvalidated2() {
  _logoutIfInvalidated2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee113(user, promise) {
    var bypassAuthState,
      _args113 = arguments;
    return _regeneratorRuntime().wrap(function _callee113$(_context113) {
      while (1) switch (_context113.prev = _context113.next) {
        case 0:
          bypassAuthState = _args113.length > 2 && _args113[2] !== undefined ? _args113[2] : false;
          if (!bypassAuthState) {
            _context113.next = 3;
            break;
          }
          return _context113.abrupt("return", promise);
        case 3:
          _context113.prev = 3;
          _context113.next = 6;
          return promise;
        ...
        case 9:
          ...
          if (!(_context113.t0 instanceof _util.FirebaseError && isUserInvalidated(_context113.t0))) {
            _context113.next = 15;
            break;
          }
...
function _reloadWithoutSaving2() {
  _reloadWithoutSaving2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee114(user) {
...
function _reload() {
  _reload = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee115(user) {
    var userInternal;
...
function _requestStsToken() {
  _requestStsToken = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee117(auth, refreshToken) {
    var response;
    return _regeneratorRuntime().wrap(function _callee117$(_context117) {
      while (1) switch (_context117.prev = _context117.next) {
        case 0:
          _context117.next = 2;
          return _performFetchWithErrorHandling(auth, {}, /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee116() {
            ...
            return _regeneratorRuntime().wrap(function _callee116$(_context116) {
              while (1) switch (_context116.prev = _context116.next) {
                case 0:
                  ...
                  return auth._getAdditionalHeaders();
                case 5:
                  headers = _context116.sent;
                  headers["Content-Type" /* HttpHeader.CONTENT_TYPE */] = 'application/x-www-form-urlencoded';
                  return _context116.abrupt("return", FetchProvider.fetch()(url, {
...
function _revokeToken() {
  _revokeToken = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee118(auth, request) {
    return _regeneratorRuntime().wrap(function _callee118$(_context118) {
      while (1) switch (_context118.prev = _context118.next) {
        case 0:
          return _context118.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v2/accounts:revokeToken" /* Endpoint.REVOKE_TOKEN */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
var UserImpl = exports.aK = /*#__PURE__*/function () {
 ...
 * @public
 */
var inMemoryPersistence = exports.U = InMemoryPersistence;
...
function _getPasswordPolicy2() {
  _getPasswordPolicy2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee119(auth) {
    var request,
      _args119 = arguments;
    return _regeneratorRuntime().wrap(function _callee119$(_context119) {
      while (1) switch (_context119.prev = _context119.next) {
        case 0:
          request = _args119.length > 1 && _args119[1] !== undefined ? _args119[1] : {};
          return _context119.abrupt("return", _performApiRequest(auth, "GET" /* HttpMethod.GET */, "/v2/passwordPolicy" /* Endpoint.GET_PASSWORD_POLICY */, _addTidIfNecessary(auth, request)));
        case 2:
        case "end":
 ...
 * limitations under the License.
 */
var AuthImpl = exports.aL = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee43$(_context43) {
          while (1) switch (_context43.prev = _context43.next) {
            case 0:
              ...
              return _context43.abrupt("return", this.app.settings.appCheckToken);
            case 2:
              _context43.next = 4;
...
var MockReCaptcha = /*#__PURE__*/function () {
  ...
  return _createClass(MockReCaptcha, [{
    ...
    key: "execute",
    value: function () {
      var _execute = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee45(optWidgetId) {
        var _a, id;
  ...
  return _createClass(MockWidget, [{
    ...
    value: function execute() {
      ...
      this.timerId = window.setTimeout(function () {
        _this13.responseToken = generateRandomAlphaNumericString(50);
        var _this13$params = _this13.params,
          callback = _this13$params.callback,
          expiredCallback = _this13$params['expired-callback'];
        if (callback) {
          try {
            callback(_this13.responseToken);
          } catch (e) {}
        }
        _this13.timerId = window.setTimeout(function () {
          _this13.timerId = null;
          _this13.responseToken = null;
          if (expiredCallback) {
            try {
              expiredCallback();
            } catch (e) {}
...
var RecaptchaEnterpriseVerifier = /*#__PURE__*/function () {
  ...
  return _createClass(RecaptchaEnterpriseVerifier, [{
    key: "verify",
    value: (function () {
      var _verify = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee48() {
        var _this14 = this;
        var action,
          forceRefresh,
          retrieveSiteKey,
          ...
          while (1) switch (_context48.prev = _context48.next) {
            case 0:
              ...
              _retrieveSiteKey = function _retrieveSiteKey3() {
                _retrieveSiteKey = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee47(auth) {
                  return _regeneratorRuntime().wrap(function _callee47$(_context47) {
                    while (1) switch (_context47.prev = _context47.next) {
                      case 0:
                        ...
                        return _context47.abrupt("return", auth._agentRecaptchaConfig.siteKey);
                      case 3:
                        if (!(auth.tenantId != null && auth._tenantRecaptchaConfigs[auth.tenantId] !== undefined)) {
                          _context47.next = 5;
                          break;
                        }
                        return _context47.abrupt("return", auth._tenantRecaptchaConfigs[auth.tenantId].siteKey);
                      case 5:
                        return _context47.abrupt("return", new Promise(/*#__PURE__*/function () {
                          var _ref12 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee46(resolve, reject) {
              ...
              retrieveSiteKey = function _retrieveSiteKey2(_x66) {
                return _retrieveSiteKey.apply(this, arguments);
              };
              action = _args48.length > 0 && _args48[0] !== undefined ? _args48[0] : 'verify';
              forceRefresh = _args48.length > 1 && _args48[1] !== undefined ? _args48[1] : false;
              if (!this.auth.settings.appVerificationDisabledForTesting) {
                _context48.next = 8;
                break;
              }
              mockRecaptcha = new MockGreCAPTCHATopLevel();
              return _context48.abrupt("return", mockRecaptcha.execute('siteKey', {
                action: 'verify'
              }));
            case 8:
              return _context48.abrupt("return", new Promise(function (resolve, reject) {
                retrieveSiteKey(_this14.auth).then(function (siteKey) {
...
function injectRecaptchaFields(_x69, _x70, _x71) {
  return _injectRecaptchaFields.apply(this, arguments);
}
function _injectRecaptchaFields() {
  _injectRecaptchaFields = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee120(auth, request, action) {
    var isCaptchaResp,
      isFakeToken,
      verifier,
      captchaResponse,
    ...
    return _regeneratorRuntime().wrap(function _callee120$(_context120) {
      while (1) switch (_context120.prev = _context120.next) {
        case 0:
          isCaptchaResp = _args120.length > 3 && _args120[3] !== undefined ? _args120[3] : false;
          isFakeToken = _args120.length > 4 && _args120[4] !== undefined ? _args120[4] : false;
        ...
        case 10:
          captchaResponse = _context120.sent;
          _context120.next = 18;
          break;
        case 13:
          _context120.prev = 13;
        ...
        case 18:
          ...
          return _context120.abrupt("return", newRequest);
        case 22:
          if (!isCaptchaResp) {
            Object.assign(newRequest, {
              captchaResponse: captchaResponse
    ...
    }, _callee120, null, [[7, 13]]);
  }));
  return _injectRecaptchaFields.apply(this, arguments);
}
function handleRecaptchaFlow(_x72, _x73, _x74, _x75, _x76) {
  return _handleRecaptchaFlow.apply(this, arguments);
}
function _handleRecaptchaFlow() {
  _handleRecaptchaFlow = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee123(authInstance, request, actionName, actionMethod, recaptchaAuthProvider) {
    ...
    return _regeneratorRuntime().wrap(function _callee123$(_context123) {
      while (1) switch (_context123.prev = _context123.next) {
        ...
        case 4:
          requestWithRecaptcha = _context123.sent;
          return _context123.abrupt("return", actionMethod(authInstance, requestWithRecaptcha));
        case 8:
          return _context123.abrupt("return", actionMethod(authInstance, request).catch(/*#__PURE__*/function () {
            var _ref42 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee121(error) {
              ...
              return _regeneratorRuntime().wrap(function _callee121$(_context121) {
                while (1) switch (_context121.prev = _context121.next) {
                  case 0:
                    ...
                    return injectRecaptchaFields(authInstance, request, actionName, actionName === "getOobCode" /* RecaptchaActionName.GET_OOB_CODE */);
                  case 4:
                    _requestWithRecaptcha = _context121.sent;
                    return _context121.abrupt("return", actionMethod(authInstance, _requestWithRecaptcha));
                  case 8:
                    return _context121.abrupt("return", Promise.reject(error));
                  case 9:
                  case "end":
        ...
        case 15:
          _requestWithRecaptcha2 = _context123.sent;
          return _context123.abrupt("return", actionMethod(authInstance, _requestWithRecaptcha2).catch(/*#__PURE__*/function () {
            var _ref43 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee122(error) {
              ...
              return _regeneratorRuntime().wrap(function _callee122$(_context122) {
                while (1) switch (_context122.prev = _context122.next) {
                  ...
                  case 5:
                    requestWithRecaptchaFields = _context122.sent;
                    return _context122.abrupt("return", actionMethod(authInstance, requestWithRecaptchaFields));
                  case 7:
                    return _context122.abrupt("return", Promise.reject(error));
                  case 8:
                  case "end":
        ...
        case 21:
          requestWithRecaptchaFields = _context123.sent;
          return _context123.abrupt("return", actionMethod(authInstance, requestWithRecaptchaFields));
        case 23:
          _context123.next = 26;
          break;
        case 25:
          return _context123.abrupt("return", Promise.reject(recaptchaAuthProvider + ' provider is not supported.'));
        case 26:
        case "end":
...
function _initializeRecaptchaConfig(_x77) {
...
function _initializeRecaptchaConfig2() {
  _initializeRecaptchaConfig2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee124(auth) {
 ...
 * @public
 */
var AuthCredential = exports.L = /*#__PURE__*/function () {
  /** @internal */
 ...
 * limitations under the License.
 */
function resetPassword(_x78, _x79) {
  return _resetPassword.apply(this, arguments);
}
function _resetPassword() {
  _resetPassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee125(auth, request) {
    return _regeneratorRuntime().wrap(function _callee125$(_context125) {
      while (1) switch (_context125.prev = _context125.next) {
        case 0:
          return _context125.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:resetPassword" /* Endpoint.RESET_PASSWORD */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function updateEmailPassword(_x80, _x81) {
  return _updateEmailPassword.apply(this, arguments);
} // Used for linking an email/password account to an existing idToken. Uses the same request/response
// format as updateEmailPassword.
function _updateEmailPassword() {
  _updateEmailPassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee126(auth, request) {
    return _regeneratorRuntime().wrap(function _callee126$(_context126) {
      while (1) switch (_context126.prev = _context126.next) {
        case 0:
          return _context126.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:update" /* Endpoint.SET_ACCOUNT_INFO */, request));
        case 1:
        case "end":
...
function linkEmailPassword(_x82, _x83) {
  return _linkEmailPassword.apply(this, arguments);
}
function _linkEmailPassword() {
  _linkEmailPassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee127(auth, request) {
    return _regeneratorRuntime().wrap(function _callee127$(_context127) {
      while (1) switch (_context127.prev = _context127.next) {
        case 0:
          return _context127.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signUp" /* Endpoint.SIGN_UP */, request));
        case 1:
        case "end":
...
function applyActionCode$1(_x84, _x85) {
...
function _applyActionCode$() {
  _applyActionCode$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee128(auth, request) {
    return _regeneratorRuntime().wrap(function _callee128$(_context128) {
      while (1) switch (_context128.prev = _context128.next) {
        case 0:
          return _context128.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:update" /* Endpoint.SET_ACCOUNT_INFO */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function signInWithPassword(_x86, _x87) {
  return _signInWithPassword.apply(this, arguments);
}
function _signInWithPassword() {
  _signInWithPassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee129(auth, request) {
    return _regeneratorRuntime().wrap(function _callee129$(_context129) {
      while (1) switch (_context129.prev = _context129.next) {
        case 0:
          return _context129.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithPassword" /* Endpoint.SIGN_IN_WITH_PASSWORD */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function sendOobCode(_x88, _x89) {
  return _sendOobCode.apply(this, arguments);
}
function _sendOobCode() {
  _sendOobCode = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee130(auth, request) {
    return _regeneratorRuntime().wrap(function _callee130$(_context130) {
      while (1) switch (_context130.prev = _context130.next) {
        case 0:
          return _context130.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:sendOobCode" /* Endpoint.SEND_OOB_CODE */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function sendEmailVerification$1(_x90, _x91) {
  return _sendEmailVerification$.apply(this, arguments);
}
function _sendEmailVerification$() {
  _sendEmailVerification$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee131(auth, request) {
    return _regeneratorRuntime().wrap(function _callee131$(_context131) {
      while (1) switch (_context131.prev = _context131.next) {
        case 0:
          return _context131.abrupt("return", sendOobCode(auth, request));
        case 1:
        case "end":
...
function sendPasswordResetEmail$1(_x92, _x93) {
  return _sendPasswordResetEmail$.apply(this, arguments);
}
function _sendPasswordResetEmail$() {
  _sendPasswordResetEmail$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee132(auth, request) {
    return _regeneratorRuntime().wrap(function _callee132$(_context132) {
      while (1) switch (_context132.prev = _context132.next) {
        case 0:
          return _context132.abrupt("return", sendOobCode(auth, request));
        case 1:
        case "end":
...
function sendSignInLinkToEmail$1(_x94, _x95) {
  return _sendSignInLinkToEmail$.apply(this, arguments);
}
function _sendSignInLinkToEmail$() {
  _sendSignInLinkToEmail$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee133(auth, request) {
    return _regeneratorRuntime().wrap(function _callee133$(_context133) {
      while (1) switch (_context133.prev = _context133.next) {
        case 0:
          return _context133.abrupt("return", sendOobCode(auth, request));
        case 1:
        case "end":
...
function verifyAndChangeEmail(_x96, _x97) {
...
function _verifyAndChangeEmail() {
  _verifyAndChangeEmail = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee134(auth, request) {
...
function signInWithEmailLink$1(_x98, _x99) {
  return _signInWithEmailLink$.apply(this, arguments);
}
function _signInWithEmailLink$() {
  _signInWithEmailLink$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee135(auth, request) {
    return _regeneratorRuntime().wrap(function _callee135$(_context135) {
      while (1) switch (_context135.prev = _context135.next) {
        case 0:
          return _context135.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithEmailLink" /* Endpoint.SIGN_IN_WITH_EMAIL_LINK */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function signInWithEmailLinkForLinking(_x100, _x101) {
...
function _signInWithEmailLinkForLinking() {
  _signInWithEmailLinkForLinking = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee136(auth, request) {
    return _regeneratorRuntime().wrap(function _callee136$(_context136) {
      while (1) switch (_context136.prev = _context136.next) {
        case 0:
          return _context136.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithEmailLink" /* Endpoint.SIGN_IN_WITH_EMAIL_LINK */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
var EmailAuthCredential = exports.M = /*#__PURE__*/function (_AuthCredential) {
  /** @internal */
  ...
  _password, signInMethod) {
    ...
    _this15 = _callSuper(this, EmailAuthCredential, ["password" /* ProviderId.PASSWORD */, signInMethod]);
    _this15._email = _email;
    _this15._password = _password;
    _this15._tenantId = _tenantId;
    return _this15;
  }
  /** @internal */
  ...
  return _createClass(EmailAuthCredential, [{
    ...
    value: (/** @internal */function () {
      var _getIdTokenResponse2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee49(auth) {
        var request;
        return _regeneratorRuntime().wrap(function _callee49$(_context49) {
          while (1) switch (_context49.prev = _context49.next) {
            ...
            case 3:
              ...
              return _context49.abrupt("return", handleRecaptchaFlow(auth, request, "signInWithPassword" /* RecaptchaActionName.SIGN_IN_WITH_PASSWORD */, signInWithPassword, "EMAIL_PASSWORD_PROVIDER" /* RecaptchaAuthProvider.EMAIL_PASSWORD_PROVIDER */));
            case 5:
              return _context49.abrupt("return", signInWithEmailLink$1(auth, {
                email: this._email,
      ...
      function _getIdTokenResponse(_x102) {
    ...
    key: "_linkToIdToken",
    value: (function () {
      var _linkToIdToken2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee50(auth, idToken) {
        var request;
        return _regeneratorRuntime().wrap(function _callee50$(_context50) {
          while (1) switch (_context50.prev = _context50.next) {
            case 0:
              _context50.t0 = this.signInMethod;
              _context50.next = _context50.t0 === "password" /* SignInMethod.EMAIL_PASSWORD */ ? 3 : _context50.t0 === "emailLink" /* SignInMethod.EMAIL_LINK */ ? 5 : 6;
              break;
            case 3:
              request = {
                idToken: idToken,
              ...
              return _context50.abrupt("return", handleRecaptchaFlow(auth, request, "signUpPassword" /* RecaptchaActionName.SIGN_UP_PASSWORD */, linkEmailPassword, "EMAIL_PASSWORD_PROVIDER" /* RecaptchaAuthProvider.EMAIL_PASSWORD_PROVIDER */));
            case 5:
              return _context50.abrupt("return", signInWithEmailLinkForLinking(auth, {
                idToken: idToken,
                email: this._email,
                oobCode: this._password
              }));
      ...
      function _linkToIdToken(_x103, _x104) {
 ...
 * limitations under the License.
 */
function signInWithIdp(_x105, _x106) {
...
function _signInWithIdp() {
  _signInWithIdp = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee137(auth, request) {
    return _regeneratorRuntime().wrap(function _callee137$(_context137) {
      while (1) switch (_context137.prev = _context137.next) {
        case 0:
          return _context137.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithIdp" /* Endpoint.SIGN_IN_WITH_IDP */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
 ...
 * @public
 */
var OAuthCredential = exports.N = /*#__PURE__*/function (_AuthCredential2) {
  function OAuthCredential() {
    var _this16;
    _classCallCheck(this, OAuthCredential);
    _this16 = _callSuper(this, OAuthCredential, arguments);
    _this16.pendingToken = null;
    return _this16;
  }
  /** @internal */
 ...
 * limitations under the License.
 */
function sendPhoneVerificationCode(_x107, _x108) {
  return _sendPhoneVerificationCode.apply(this, arguments);
}
function _sendPhoneVerificationCode() {
  _sendPhoneVerificationCode = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee138(auth, request) {
    return _regeneratorRuntime().wrap(function _callee138$(_context138) {
      while (1) switch (_context138.prev = _context138.next) {
        case 0:
          return _context138.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:sendVerificationCode" /* Endpoint.SEND_VERIFICATION_CODE */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function signInWithPhoneNumber$1(_x109, _x110) {
  return _signInWithPhoneNumber$.apply(this, arguments);
}
function _signInWithPhoneNumber$() {
  _signInWithPhoneNumber$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee139(auth, request) {
    return _regeneratorRuntime().wrap(function _callee139$(_context139) {
      while (1) switch (_context139.prev = _context139.next) {
        case 0:
          return _context139.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithPhoneNumber" /* Endpoint.SIGN_IN_WITH_PHONE_NUMBER */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function linkWithPhoneNumber$1(_x111, _x112) {
  return _linkWithPhoneNumber$.apply(this, arguments);
}
function _linkWithPhoneNumber$() {
  _linkWithPhoneNumber$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee140(auth, request) {
    var response;
...
function verifyPhoneNumberForExisting(_x113, _x114) {
...
function _verifyPhoneNumberForExisting() {
  _verifyPhoneNumberForExisting = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee141(auth, request) {
    var apiRequest;
    return _regeneratorRuntime().wrap(function _callee141$(_context141) {
      while (1) switch (_context141.prev = _context141.next) {
        case 0:
          ...
          return _context141.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithPhoneNumber" /* Endpoint.SIGN_IN_WITH_PHONE_NUMBER */, _addTidIfNecessary(auth, apiRequest), VERIFY_PHONE_NUMBER_FOR_EXISTING_ERROR_MAP_));
        case 2:
        case "end":
...
var PhoneAuthCredential = exports.Q = /*#__PURE__*/function (_AuthCredential3) {
  function PhoneAuthCredential(params) {
    var _this17;
    _classCallCheck(this, PhoneAuthCredential);
    _this17 = _callSuper(this, PhoneAuthCredential, ["phone" /* ProviderId.PHONE */, "phone" /* SignInMethod.PHONE */]);
 ...
 * @public
 */
var ActionCodeURL = exports.ai = /*#__PURE__*/function () {
  /**
 ...
 * @public
 */
var EmailAuthProvider = exports.V = /*#__PURE__*/function () {
...
var BaseOAuthProvider = /*#__PURE__*/function (_FederatedAuthProvide) {
  function BaseOAuthProvider() {
    ...
    _this18 = _callSuper(this, BaseOAuthProvider, arguments);
    /** @internal */
    _this18.scopes = [];
    return _this18;
  }
 ...
 * @public
 */
var OAuthProvider = exports.Z = /*#__PURE__*/function (_BaseOAuthProvider) {
 ...
 * @public
 */
var FacebookAuthProvider = exports.W = /*#__PURE__*/function (_BaseOAuthProvider2) {
 ...
 * @public
 */
var GoogleAuthProvider = exports.X = /*#__PURE__*/function (_BaseOAuthProvider3) {
  function GoogleAuthProvider() {
    var _this19;
    _classCallCheck(this, GoogleAuthProvider);
    _this19 = _callSuper(this, GoogleAuthProvider, ["google.com" /* ProviderId.GOOGLE */]);
    _this19.addScope('profile');
    return _this19;
  }
  /**
 ...
 * @public
 */
var GithubAuthProvider = exports.Y = /*#__PURE__*/function (_BaseOAuthProvider4) {
 ...
 * @public
 */
var SAMLAuthCredential = exports.aQ = /*#__PURE__*/function (_AuthCredential4) {
  /** @internal */
  function SAMLAuthCredential(providerId, pendingToken) {
    var _this20;
    _classCallCheck(this, SAMLAuthCredential);
    _this20 = _callSuper(this, SAMLAuthCredential, [providerId, providerId]);
    _this20.pendingToken = pendingToken;
    return _this20;
  }
  /** @internal */
 ...
 * @public
 */
var SAMLAuthProvider = exports._ = /*#__PURE__*/function (_FederatedAuthProvide2) {
  /**
 ...
 * @public
 */
var TwitterAuthProvider = exports.$ = /*#__PURE__*/function (_BaseOAuthProvider5) {
 ...
 */
function _signUp() {
  _signUp = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee142(auth, request) {
    return _regeneratorRuntime().wrap(function _callee142$(_context142) {
      while (1) switch (_context142.prev = _context142.next) {
        case 0:
          return _context142.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signUp" /* Endpoint.SIGN_UP */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
var UserCredentialImpl = /*#__PURE__*/function () {
  ...
  return _createClass(UserCredentialImpl, null, [{
    key: "_fromIdTokenResponse",
    value: function () {
      var _fromIdTokenResponse3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee51(auth, operationType, idTokenResponse) {
        var isAnonymous,
          user,
          providerId,
          userCred,
        ...
        return _regeneratorRuntime().wrap(function _callee51$(_context51) {
          while (1) switch (_context51.prev = _context51.next) {
            case 0:
              isAnonymous = _args51.length > 3 && _args51[3] !== undefined ? _args51[3] : false;
              _context51.next = 3;
            ...
            case 3:
              ...
              return _context51.abrupt("return", userCred);
            case 7:
            case "end":
      ...
      function _fromIdTokenResponse(_x117, _x118, _x119) {
    ...
    key: "_forOperation",
    value: function () {
      var _forOperation2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee52(user, operationType, response) {
        var providerId;
        return _regeneratorRuntime().wrap(function _callee52$(_context52) {
          while (1) switch (_context52.prev = _context52.next) {
            ...
            case 2:
              ...
              return _context52.abrupt("return", new UserCredentialImpl({
                user: user,
                providerId: providerId,
      ...
      function _forOperation(_x120, _x121, _x122) {
 ...
 * @public
 */
function signInAnonymously(_x123) {
...
function _signInAnonymously() {
  _signInAnonymously = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee143(auth) {
    ...
    return _regeneratorRuntime().wrap(function _callee143$(_context143) {
      while (1) switch (_context143.prev = _context143.next) {
        case 0:
          ...
          return _context143.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 2:
          authInternal = _castAuth(auth);
          _context143.next = 5;
        ...
        case 5:
          ...
          return _context143.abrupt("return", new UserCredentialImpl({
        ...
        case 12:
          userCredential = _context143.sent;
          _context143.next = 15;
          return authInternal._updateCurrentUser(userCredential.user);
        case 15:
          return _context143.abrupt("return", userCredential);
        case 16:
        case "end":
...
var MultiFactorError = /*#__PURE__*/function (_FirebaseError) {
  function MultiFactorError(auth, error, operationType, user) {
    ...
    var _a;
    _this21 = _callSuper(this, MultiFactorError, [error.code, error.message]);
    _this21.operationType = operationType;
    _this21.user = user;
    // https://github.com/Microsoft/TypeScript-wiki/blob/master/Breaking-Changes.md#extending-built-ins-like-error-array-and-map-may-no-longer-work
    Object.setPrototypeOf(_this21, MultiFactorError.prototype);
    _this21.customData = {
      appName: auth.name,
 ...
 * @public
 */
function unlink(_x124, _x125) {
  return _unlink.apply(this, arguments);
}
function _unlink() {
  _unlink = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee144(user, providerId) {
    ...
    return _regeneratorRuntime().wrap(function _callee144$(_context144) {
      while (1) switch (_context144.prev = _context144.next) {
        ...
        case 3:
          _context144.t0 = deleteLinkedAccounts;
          _context144.t1 = userInternal.auth;
          _context144.next = 7;
          return userInternal.getIdToken();
        case 7:
          _context144.t2 = _context144.sent;
          _context144.t3 = [providerId];
          _context144.t4 = {
            idToken: _context144.t2,
            deleteProvider: _context144.t3
          };
          _context144.next = 12;
          return (0, _context144.t0)(_context144.t1, _context144.t4);
        case 12:
          _yield$deleteLinkedAc = _context144.sent;
          ...
          return userInternal.auth._persistUserIfCurrent(userInternal);
        case 19:
          return _context144.abrupt("return", userInternal);
        case 20:
        case "end":
...
function _link$1(_x126, _x127) {
  return _link$.apply(this, arguments);
}
function _link$() {
  _link$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee145(user, credential) {
    var bypassAuthState,
      response,
      _args145 = arguments;
    return _regeneratorRuntime().wrap(function _callee145$(_context145) {
      while (1) switch (_context145.prev = _context145.next) {
        case 0:
          bypassAuthState = _args145.length > 2 && _args145[2] !== undefined ? _args145[2] : false;
          _context145.t0 = _logoutIfInvalidated;
          _context145.t1 = user;
          _context145.t2 = credential;
          _context145.t3 = user.auth;
          _context145.next = 7;
          return user.getIdToken();
        case 7:
          _context145.t4 = _context145.sent;
          _context145.t5 = _context145.t2._linkToIdToken.call(_context145.t2, _context145.t3, _context145.t4);
          _context145.t6 = bypassAuthState;
          _context145.next = 12;
          return (0, _context145.t0)(_context145.t1, _context145.t5, _context145.t6);
        case 12:
          response = _context145.sent;
          return _context145.abrupt("return", UserCredentialImpl._forOperation(user, "link" /* OperationType.LINK */, response));
        case 14:
        case "end":
...
function _assertLinkedStatus(_x128, _x129, _x130) {
...
function _assertLinkedStatus2() {
  _assertLinkedStatus2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee146(expected, user, provider) {
...
function _reauthenticate(_x131, _x132) {
...
function _reauthenticate2() {
  _reauthenticate2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee147(user, credential) {
    var bypassAuthState,
      auth,
      operationType,
      response,
    ...
    return _regeneratorRuntime().wrap(function _callee147$(_context147) {
      while (1) switch (_context147.prev = _context147.next) {
        case 0:
          bypassAuthState = _args147.length > 2 && _args147[2] !== undefined ? _args147[2] : false;
          auth = user.auth;
          if (!(0, _app._isFirebaseServerApp)(auth.app)) {
            _context147.next = 4;
            break;
          }
          return _context147.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 4:
        ...
        case 8:
          ...
          return _context147.abrupt("return", UserCredentialImpl._forOperation(user, operationType, response));
        case 17:
          _context147.prev = 17;
          _context147.t0 = _context147["catch"](5);
          // Convert user deleted error into user mismatch
          if ((_context147.t0 === null || _context147.t0 === void 0 ? void 0 : _context147.t0.code) === "auth/".concat("user-not-found" /* AuthErrorCode.USER_DELETED */)) {
            _fail(auth, "user-mismatch" /* AuthErrorCode.USER_MISMATCH */);
          }
          throw _context147.t0;
        case 21:
        case "end":
          return _context147.stop();
      }
    }, _callee147, null, [[5, 17]]);
  }));
  return _reauthenticate2.apply(this, arguments);
}
function _signInWithCredential(_x133, _x134) {
...
function _signInWithCredential2() {
  _signInWithCredential2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee148(auth, credential) {
    var bypassAuthState,
      operationType,
      response,
      userCredential,
    ...
    return _regeneratorRuntime().wrap(function _callee148$(_context148) {
      while (1) switch (_context148.prev = _context148.next) {
        case 0:
          ...
          return _context148.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 3:
        ...
        case 9:
          userCredential = _context148.sent;
          if (bypassAuthState) {
            _context148.next = 13;
            break;
          }
        ...
        case 13:
          return _context148.abrupt("return", userCredential);
        case 14:
        case "end":
...
function signInWithCredential(_x135, _x136) {
...
function _signInWithCredential3() {
  _signInWithCredential3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee149(auth, credential) {
    return _regeneratorRuntime().wrap(function _callee149$(_context149) {
      while (1) switch (_context149.prev = _context149.next) {
        case 0:
          return _context149.abrupt("return", _signInWithCredential(_castAuth(auth), credential));
        case 1:
        case "end":
...
function linkWithCredential(_x137, _x138) {
...
function _linkWithCredential() {
  _linkWithCredential = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee150(user, credential) {
    var userInternal;
    return _regeneratorRuntime().wrap(function _callee150$(_context150) {
      while (1) switch (_context150.prev = _context150.next) {
        ...
        case 3:
          return _context150.abrupt("return", _link$1(userInternal, credential));
        case 4:
        case "end":
...
function reauthenticateWithCredential(_x139, _x140) {
...
function _reauthenticateWithCredential() {
  _reauthenticateWithCredential = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee151(user, credential) {
    return _regeneratorRuntime().wrap(function _callee151$(_context151) {
      while (1) switch (_context151.prev = _context151.next) {
        case 0:
          return _context151.abrupt("return", _reauthenticate((0, _util.getModularInstance)(user), credential));
        case 1:
        case "end":
...
function signInWithCustomToken$1(_x141, _x142) {
...
function _signInWithCustomToken$() {
  _signInWithCustomToken$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee152(auth, request) {
    return _regeneratorRuntime().wrap(function _callee152$(_context152) {
      while (1) switch (_context152.prev = _context152.next) {
        case 0:
          return _context152.abrupt("return", _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithCustomToken" /* Endpoint.SIGN_IN_WITH_CUSTOM_TOKEN */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function signInWithCustomToken(_x143, _x144) {
  return _signInWithCustomToken.apply(this, arguments);
}
/**
 * @license
 ...
 */
function _signInWithCustomToken() {
  _signInWithCustomToken = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee153(auth, customToken) {
    ...
    return _regeneratorRuntime().wrap(function _callee153$(_context153) {
      while (1) switch (_context153.prev = _context153.next) {
        case 0:
          ...
          return _context153.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 2:
          authInternal = _castAuth(auth);
          _context153.next = 5;
        ...
        case 8:
          cred = _context153.sent;
          _context153.next = 11;
          return authInternal._updateCurrentUser(cred.user);
        case 11:
          return _context153.abrupt("return", cred);
        case 12:
        case "end":
...
var PhoneMultiFactorInfoImpl = /*#__PURE__*/function (_MultiFactorInfoImpl) {
  function PhoneMultiFactorInfoImpl(response) {
    ...
    _this22 = _callSuper(this, PhoneMultiFactorInfoImpl, ["phone" /* FactorId.PHONE */, response]);
    _this22.phoneNumber = response.phoneInfo;
    return _this22;
  }
 ...
 * @private
 */
function recachePasswordPolicy(_x145) {
...
function _recachePasswordPolicy() {
  _recachePasswordPolicy = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee154(auth) {
    var authInternal;
...
function sendPasswordResetEmail(_x146, _x147, _x148) {
  return _sendPasswordResetEmail.apply(this, arguments);
}
/**
 ...
 */
function _sendPasswordResetEmail() {
  _sendPasswordResetEmail = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee155(auth, email, actionCodeSettings) {
...
function confirmPasswordReset(_x149, _x150, _x151) {
...
function _confirmPasswordReset() {
  _confirmPasswordReset = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee157(auth, oobCode, newPassword) {
      ...
      while (1) switch (_context157.prev = _context157.next) {
        case 0:
          ...
          return resetPassword((0, _util.getModularInstance)(auth), {
            ...
            var _ref44 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee156(error) {
...
function applyActionCode(_x152, _x153) {
  return _applyActionCode.apply(this, arguments);
}
/**
 ...
 */
function _applyActionCode() {
  _applyActionCode = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee158(auth, oobCode) {
...
function checkActionCode(_x154, _x155) {
...
function _checkActionCode() {
  _checkActionCode = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee159(auth, oobCode) {
    ...
    return _regeneratorRuntime().wrap(function _callee159$(_context159) {
      while (1) switch (_context159.prev = _context159.next) {
        ...
        case 3:
          ...
          _context159.t0 = operation;
          _context159.next = _context159.t0 === "EMAIL_SIGNIN" /* ActionCodeOperation.EMAIL_SIGNIN */ ? 9 : _context159.t0 === "VERIFY_AND_CHANGE_EMAIL" /* ActionCodeOperation.VERIFY_AND_CHANGE_EMAIL */ ? 10 : _context159.t0 === "REVERT_SECOND_FACTOR_ADDITION" /* ActionCodeOperation.REVERT_SECOND_FACTOR_ADDITION */ ? 12 : 13;
          break;
        case 9:
          return _context159.abrupt("break", 14);
        case 10:
...
function verifyPasswordResetCode(_x156, _x157) {
...
function _verifyPasswordResetCode() {
  _verifyPasswordResetCode = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee160(auth, code) {
    ...
    return _regeneratorRuntime().wrap(function _callee160$(_context160) {
      while (1) switch (_context160.prev = _context160.next) {
        ...
        case 2:
          _yield$checkActionCod = _context160.sent;
          data = _yield$checkActionCod.data;
          return _context160.abrupt("return", data.email);
        case 5:
        case "end":
...
function createUserWithEmailAndPassword(_x158, _x159, _x160) {
...
function _createUserWithEmailAndPassword() {
  _createUserWithEmailAndPassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee161(auth, email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee161$(_context161) {
      while (1) switch (_context161.prev = _context161.next) {
        case 0:
          ...
          return _context161.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 2:
          authInternal = _castAuth(auth);
          request = {
            returnSecureToken: true,
        ...
        case 7:
          ...
          return UserCredentialImpl._fromIdTokenResponse(authInternal, "signIn" /* OperationType.SIGN_IN */, response);
        case 10:
          userCredential = _context161.sent;
          _context161.next = 13;
          return authInternal._updateCurrentUser(userCredential.user);
        case 13:
          return _context161.abrupt("return", userCredential);
        case 14:
        case "end":
...
function signInWithEmailAndPassword(auth, email, password) {
  ...
  return signInWithCredential((0, _util.getModularInstance)(auth), EmailAuthProvider.credential(email, password)).catch(/*#__PURE__*/function () {
    var _ref20 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee53(error) {
 ...
 * @public
 */
function sendSignInLinkToEmail(_x162, _x163, _x164) {
  return _sendSignInLinkToEmail.apply(this, arguments);
}
/**
 ...
 */
function _sendSignInLinkToEmail() {
  _sendSignInLinkToEmail = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee162(auth, email, actionCodeSettings) {
 ...
 * @public
 */
function signInWithEmailLink(_x165, _x166, _x167) {
  return _signInWithEmailLink.apply(this, arguments);
}
/**
 * @license
 ...
 */
function _signInWithEmailLink() {
  _signInWithEmailLink = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee163(auth, email, emailLink) {
    ...
    return _regeneratorRuntime().wrap(function _callee163$(_context163) {
      while (1) switch (_context163.prev = _context163.next) {
        case 0:
          ...
          return _context163.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 2:
          authModular = (0, _util.getModularInstance)(auth);
          ...
          return _context163.abrupt("return", signInWithCredential(authModular, credential));
        case 6:
        case "end":
...
function createAuthUri(_x168, _x169) {
...
function _createAuthUri() {
  _createAuthUri = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee164(auth, request) {
    return _regeneratorRuntime().wrap(function _callee164$(_context164) {
      while (1) switch (_context164.prev = _context164.next) {
        case 0:
          return _context164.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:createAuthUri" /* Endpoint.CREATE_AUTH_URI */, _addTidIfNecessary(auth, request)));
        case 1:
        case "end":
...
function fetchSignInMethodsForEmail(_x170, _x171) {
...
function _fetchSignInMethodsForEmail() {
  _fetchSignInMethodsForEmail = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee165(auth, email) {
    ...
    return _regeneratorRuntime().wrap(function _callee165$(_context165) {
      while (1) switch (_context165.prev = _context165.next) {
        ...
        case 4:
          _yield$createAuthUri = _context165.sent;
          signinMethods = _yield$createAuthUri.signinMethods;
          return _context165.abrupt("return", signinMethods || []);
        case 7:
        case "end":
...
function sendEmailVerification(_x172, _x173) {
  return _sendEmailVerification.apply(this, arguments);
}
/**
 ...
 */
function _sendEmailVerification() {
  _sendEmailVerification = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee166(user, actionCodeSettings) {
    ...
    return _regeneratorRuntime().wrap(function _callee166$(_context166) {
      while (1) switch (_context166.prev = _context166.next) {
        ...
        case 8:
          _yield$sendEmailVerif = _context166.sent;
...
function verifyBeforeUpdateEmail(_x174, _x175, _x176) {
...
function _verifyBeforeUpdateEmail() {
  _verifyBeforeUpdateEmail = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee167(user, newEmail, actionCodeSettings) {
    ...
    return _regeneratorRuntime().wrap(function _callee167$(_context167) {
      while (1) switch (_context167.prev = _context167.next) {
        ...
        case 8:
          _yield$verifyAndChang = _context167.sent;
...
function updateProfile$1(_x177, _x178) {
...
function _updateProfile$() {
  _updateProfile$ = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee168(auth, request) {
    return _regeneratorRuntime().wrap(function _callee168$(_context168) {
      while (1) switch (_context168.prev = _context168.next) {
        case 0:
          return _context168.abrupt("return", _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:update" /* Endpoint.SET_ACCOUNT_INFO */, request));
        case 1:
        case "end":
...
function updateProfile(_x179, _x180) {
  return _updateProfile.apply(this, arguments);
}
/**
 ...
 */
function _updateProfile() {
  _updateProfile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee169(user, _ref21) {
    ...
    return _regeneratorRuntime().wrap(function _callee169$(_context169) {
      while (1) switch (_context169.prev = _context169.next) {
        ...
        case 10:
          ...
          passwordProvider = userInternal.providerData.find(function (_ref45) {
...
function updateEmailOrPassword(_x181, _x182, _x183) {
...
function _updateEmailOrPassword() {
  _updateEmailOrPassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee170(user, email, password) {
...
var FederatedAdditionalUserInfoWithUsername = /*#__PURE__*/function (_GenericAdditionalUse) {
  function FederatedAdditionalUserInfoWithUsername(isNewUser, providerId, profile, username) {
    ...
    _this23 = _callSuper(this, FederatedAdditionalUserInfoWithUsername, [isNewUser, providerId, profile]);
 ...
 * @public
 */
function validatePassword(_x184, _x185) {
...
function _validatePassword2() {
  _validatePassword2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee171(auth, password) {
    var authInternal;
    return _regeneratorRuntime().wrap(function _callee171$(_context171) {
      while (1) switch (_context171.prev = _context171.next) {
        case 0:
          authInternal = _castAuth(auth);
          return _context171.abrupt("return", authInternal.validatePassword(password));
        case 2:
        case "end":
...
function _deleteUser() {
  _deleteUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee172(user) {
    return _regeneratorRuntime().wrap(function _callee172$(_context172) {
      while (1) switch (_context172.prev = _context172.next) {
        case 0:
          return _context172.abrupt("return", (0, _util.getModularInstance)(user).delete());
        case 1:
        case "end":
...
var MultiFactorResolverImpl = /*#__PURE__*/function () {
  ...
  return _createClass(MultiFactorResolverImpl, [{
    key: "resolveSignIn",
    value: function () {
      var _resolveSignIn = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee54(assertionExtern) {
        var assertion;
        return _regeneratorRuntime().wrap(function _callee54$(_context54) {
          while (1) switch (_context54.prev = _context54.next) {
            case 0:
              assertion = assertionExtern;
              return _context54.abrupt("return", this.signInResolver(assertion));
            case 2:
            case "end":
    ...
    value: function _fromError(authExtern, error) {
      ...
      return new MultiFactorResolverImpl(session, hints, /*#__PURE__*/function () {
        var _ref22 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee55(assertion) {
          ...
          return _regeneratorRuntime().wrap(function _callee55$(_context55) {
            while (1) switch (_context55.prev = _context55.next) {
              ...
              case 2:
                ...
                _context55.t0 = error.operationType;
                _context55.next = _context55.t0 === "signIn" /* OperationType.SIGN_IN */ ? 9 : _context55.t0 === "reauthenticate" /* OperationType.REAUTHENTICATE */ ? 15 : 17;
                break;
              case 9:
                _context55.next = 11;
                return UserCredentialImpl._fromIdTokenResponse(auth, error.operationType, idTokenResponse);
              case 11:
                userCredential = _context55.sent;
                _context55.next = 14;
                return auth._updateCurrentUser(userCredential.user);
              case 14:
                return _context55.abrupt("return", userCredential);
              case 15:
                _assert(error.user, auth, "internal-error" /* AuthErrorCode.INTERNAL_ERROR */);
                return _context55.abrupt("return", UserCredentialImpl._forOperation(error.user, error.operationType, idTokenResponse));
              case 17:
                _fail(auth, "internal-error" /* AuthErrorCode.INTERNAL_ERROR */);
              case 18:
              case "end":
...
var MultiFactorUserImpl = /*#__PURE__*/function () {
  function MultiFactorUserImpl(user) {
    ...
    user._onReload(function (userInfo) {
      if (userInfo.mfaInfo) {
        _this24.enrolledFactors = userInfo.mfaInfo.map(function (enrollment) {
  ...
  return _createClass(MultiFactorUserImpl, [{
    key: "getSession",
    value: function () {
      var _getSession = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee56() {
        return _regeneratorRuntime().wrap(function _callee56$(_context56) {
          while (1) switch (_context56.prev = _context56.next) {
            case 0:
              _context56.t0 = MultiFactorSessionImpl;
              _context56.next = 3;
              return this.user.getIdToken();
            case 3:
              _context56.t1 = _context56.sent;
              _context56.t2 = this.user;
              return _context56.abrupt("return", _context56.t0._fromIdtoken.call(_context56.t0, _context56.t1, _context56.t2));
            case 6:
            case "end":
    ...
    key: "enroll",
    value: function () {
      var _enroll = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee57(assertionExtern, displayName) {
        ...
        return _regeneratorRuntime().wrap(function _callee57$(_context57) {
          while (1) switch (_context57.prev = _context57.next) {
            ...
            case 6:
              finalizeMfaResponse = _context57.sent;
              _context57.next = 9;
              return this.user._updateTokensIfNecessary(finalizeMfaResponse);
            case 9:
              return _context57.abrupt("return", this.user.reload());
            case 10:
            case "end":
    ...
    key: "unenroll",
    value: function () {
      var _unenroll = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee58(infoOrUid) {
        ...
        return _regeneratorRuntime().wrap(function _callee58$(_context58) {
          while (1) switch (_context58.prev = _context58.next) {
            ...
            case 7:
              idTokenResponse = _context58.sent;
...
var BrowserLocalPersistence = /*#__PURE__*/function (_BrowserPersistenceCl) {
  function BrowserLocalPersistence() {
    ...
    _this25 = _callSuper(this, BrowserLocalPersistence, [function () {
      return window.localStorage;
    }, "LOCAL" /* PersistenceType.LOCAL */]);
    _this25.boundEventHandler = function (event, poll) {
      return _this25.onStorageEvent(event, poll);
    };
    _this25.listeners = {};
    _this25.localCache = {};
    // setTimeout return value is platform specific
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    _this25.pollTimer = null;
    // Whether to use polling instead of depending on window events
    _this25.fallbackToPolling = _isMobileBrowser();
    _this25._shouldAllowMigration = true;
    return _this25;
  }
  ...
  return _createClass(BrowserLocalPersistence, [{
    ...
    value: function onStorageEvent(event) {
      ...
      if (!event.key) {
        this.forAllChangedKeys(function (key, _oldValue, newValue) {
          _this26.notifyListeners(key, newValue);
        });
        return;
      }
      var key = event.key;
      ...
      var triggerListeners = function triggerListeners() {
        ...
        // poll.
        var storedValue = _this26.storage.getItem(key);
        if (!poll && _this26.localCache[key] === storedValue) {
          // Real storage event which has already been detected, do nothing.
          // This seems to trigger in some IE browsers for some reason.
          return;
        }
        _this26.notifyListeners(key, storedValue);
      };
    ...
    value: function startPolling() {
      ...
      this.pollTimer = setInterval(function () {
        _this27.forAllChangedKeys(function (key, oldValue, newValue) {
          _this27.onStorageEvent(new StorageEvent('storage', {
            key: key,
            oldValue: oldValue,
            newValue: newValue
          }), /* poll */true);
    ...
    key: "_set",
    value: function () {
      var _set3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee59(key, value) {
    ...
    key: "_get",
    value: function () {
      var _get4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee60(key) {
        var value;
        return _regeneratorRuntime().wrap(function _callee60$(_context60) {
          while (1) switch (_context60.prev = _context60.next) {
            ...
            case 2:
              ...
              this.localCache[key] = JSON.stringify(value);
              return _context60.abrupt("return", value);
            case 5:
            case "end":
    ...
    key: "_remove",
    value: function () {
      var _remove3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee61(key) {
 ...
 * @public
 */
var browserSessionPersistence = exports.a = BrowserSessionPersistence;
...
function _allSettled(promises) {
  return Promise.all(promises.map(/*#__PURE__*/function () {
    var _ref24 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee62(promise) {
      var value;
...
var Receiver = /*#__PURE__*/function () {
  ...
  return _createClass(Receiver, [{
    ...
    key: "handleEvent",
    value: (function () {
      var _handleEvent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee64(event) {
          ...
          while (1) switch (_context64.prev = _context64.next) {
            ...
            case 5:
              ...
              promises = Array.from(handlers).map(/*#__PURE__*/function () {
                var _ref25 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee63(handler) {
                  return _regeneratorRuntime().wrap(function _callee63$(_context63) {
                    while (1) switch (_context63.prev = _context63.next) {
                      case 0:
                        return _context63.abrupt("return", handler(messageEvent.origin, data));
                      case 1:
                      case "end":
...
var Sender = /*#__PURE__*/function () {
  ...
  return _createClass(Sender, [{
    ...
    key: "_send",
    value: (function () {
      var _send2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee65(eventType, data) {
        var _this28 = this;
        var timeout,
          messageChannel,
          completionTimer,
        ...
        return _regeneratorRuntime().wrap(function _callee65$(_context65) {
          while (1) switch (_context65.prev = _context65.next) {
            case 0:
              timeout = _args65.length > 2 && _args65[2] !== undefined ? _args65[2] : 50;
            ...
            case 4:
              return _context65.abrupt("return", new Promise(function (resolve, reject) {
                ...
                _this28.handlers.add(handler);
                messageChannel.port1.addEventListener('message', handler.onMessage);
                _this28.target.postMessage({
                  eventType: eventType,
                  eventId: eventId,
                  data: data
                ...
                if (handler) {
                  _this28.removeMessageHandler(handler);
                }
              }));
            case 5:
            case "end":
...
function _getActiveServiceWorker2() {
  _getActiveServiceWorker2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee173() {
    var registration;
    return _regeneratorRuntime().wrap(function _callee173$(_context173) {
      while (1) switch (_context173.prev = _context173.next) {
        case 0:
          ...
          return _context173.abrupt("return", null);
        case 2:
          _context173.prev = 2;
          _context173.next = 5;
          return navigator.serviceWorker.ready;
        case 5:
          registration = _context173.sent;
          return _context173.abrupt("return", registration.active);
        case 9:
          _context173.prev = 9;
          _context173.t0 = _context173["catch"](2);
          return _context173.abrupt("return", null);
        case 12:
        case "end":
...
var DBPromise = /*#__PURE__*/function () {
  ...
  return _createClass(DBPromise, [{
    ...
    value: function toPromise() {
      var _this29 = this;
      return new Promise(function (resolve, reject) {
        _this29.request.addEventListener('success', function () {
          resolve(_this29.request.result);
        });
        _this29.request.addEventListener('error', function () {
          reject(_this29.request.error);
        });
      });
    }
  }]);
...
function _openDatabase() {
  ...
  return new Promise(function (resolve, reject) {
    ...
    request.addEventListener('success', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee66() {
      var db;
      return _regeneratorRuntime().wrap(function _callee66$(_context66) {
        while (1) switch (_context66.prev = _context66.next) {
          ...
          case 5:
            _context66.t0 = resolve;
            _context66.next = 8;
            return _openDatabase();
          case 8:
            _context66.t1 = _context66.sent;
            (0, _context66.t0)(_context66.t1);
            _context66.next = 13;
            break;
          case 12:
            resolve(db);
...
function _putObject(_x201, _x202, _x203) {
  return _putObject2.apply(this, arguments);
}
function _putObject2() {
  _putObject2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee174(db, key, value) {
    var request;
    return _regeneratorRuntime().wrap(function _callee174$(_context174) {
      while (1) switch (_context174.prev = _context174.next) {
        case 0:
          ...
          return _context174.abrupt("return", new DBPromise(request).toPromise());
        case 2:
        case "end":
...
function getObject(_x204, _x205) {
  return _getObject.apply(this, arguments);
}
function _getObject() {
  _getObject = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee175(db, key) {
    var request, data;
    return _regeneratorRuntime().wrap(function _callee175$(_context175) {
      while (1) switch (_context175.prev = _context175.next) {
        case 0:
          ...
          return new DBPromise(request).toPromise();
        case 3:
          data = _context175.sent;
          return _context175.abrupt("return", data === undefined ? null : data.value);
        case 5:
        case "end":
...
var IndexedDBLocalPersistence = /*#__PURE__*/function () {
  ...
  return _createClass(IndexedDBLocalPersistence, [{
    key: "_openDb",
    value: function () {
      var _openDb2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee67() {
        return _regeneratorRuntime().wrap(function _callee67$(_context67) {
          while (1) switch (_context67.prev = _context67.next) {
            case 0:
              ...
              return _context67.abrupt("return", this.db);
            case 2:
              _context67.next = 4;
              return _openDatabase();
            case 4:
              this.db = _context67.sent;
              return _context67.abrupt("return", this.db);
            case 6:
            case "end":
    ...
    key: "_withRetries",
    value: function () {
      var _withRetries2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee68(op) {
        var numAttempts, db;
    ...
    value: (function () {
      var _initializeServiceWorkerMessaging = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee69() {
        return _regeneratorRuntime().wrap(function _callee69$(_context69) {
          while (1) switch (_context69.prev = _context69.next) {
            case 0:
              return _context69.abrupt("return", _isWorker() ? this.initializeReceiver() : this.initializeSender());
            case 1:
            case "end":
    ...
    value: (function () {
      var _initializeReceiver = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee72() {
        var _this30 = this;
          ...
          while (1) switch (_context72.prev = _context72.next) {
            case 0:
              ...
              this.receiver._subscribe("keyChanged" /* _EventType.KEY_CHANGED */, /*#__PURE__*/function () {
                var _ref27 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee70(_origin, data) {
                  var keys;
                  return _regeneratorRuntime().wrap(function _callee70$(_context70) {
                    while (1) switch (_context70.prev = _context70.next) {
                      case 0:
                        _context70.next = 2;
                        return _this30._poll();
                      case 2:
                        keys = _context70.sent;
              ...
              this.receiver._subscribe("ping" /* _EventType.PING */, /*#__PURE__*/function () {
                var _ref28 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee71(_origin, _data) {
                  return _regeneratorRuntime().wrap(function _callee71$(_context71) {
                    while (1) switch (_context71.prev = _context71.next) {
                      case 0:
                        return _context71.abrupt("return", ["keyChanged" /* _EventType.KEY_CHANGED */]);
                      case 1:
                      case "end":
    ...
    value: (function () {
      var _initializeSender = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee73() {
        var _a, _b, results;
        return _regeneratorRuntime().wrap(function _callee73$(_context73) {
          while (1) switch (_context73.prev = _context73.next) {
            ...
            case 2:
              this.activeServiceWorker = _context73.sent;
    ...
    value: (function () {
      var _notifyServiceWorker = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee74(key) {
      ...
      function notifyServiceWorker(_x211) {
    ...
    key: "_isAvailable",
    value: function () {
      var _isAvailable3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee75() {
        var db;
    ...
    value: function () {
      var _withPendingWrite2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee76(write) {
        return _regeneratorRuntime().wrap(function _callee76$(_context76) {
          while (1) switch (_context76.prev = _context76.next) {
            ...
            case 4:
              _context76.prev = 4;
              this.pendingWrites--;
              return _context76.finish(4);
            case 7:
            case "end":
              return _context76.stop();
          }
        }, _callee76, this, [[1,, 4, 7]]);
      }));
      function _withPendingWrite(_x212) {
    ...
    key: "_set",
    value: function () {
      var _set4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee78(key, value) {
        var _this31 = this;
        return _regeneratorRuntime().wrap(function _callee78$(_context78) {
          while (1) switch (_context78.prev = _context78.next) {
            case 0:
              return _context78.abrupt("return", this._withPendingWrite(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee77() {
                return _regeneratorRuntime().wrap(function _callee77$(_context77) {
                  while (1) switch (_context77.prev = _context77.next) {
                    ...
                    case 2:
                      _this31.localCache[key] = value;
                      return _context77.abrupt("return", _this31.notifyServiceWorker(key));
                    case 4:
                    case "end":
    ...
    key: "_get",
    value: function () {
      var _get5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee79(key) {
        var obj;
        return _regeneratorRuntime().wrap(function _callee79$(_context79) {
          while (1) switch (_context79.prev = _context79.next) {
            ...
            case 2:
              ...
              return _context79.abrupt("return", obj);
            case 5:
            case "end":
    ...
    key: "_remove",
    value: function () {
      var _remove4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee81(key) {
        var _this32 = this;
        return _regeneratorRuntime().wrap(function _callee81$(_context81) {
          while (1) switch (_context81.prev = _context81.next) {
            case 0:
              return _context81.abrupt("return", this._withPendingWrite(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee80() {
                return _regeneratorRuntime().wrap(function _callee80$(_context80) {
                  while (1) switch (_context80.prev = _context80.next) {
                    case 0:
                      _context80.next = 2;
                      return _this32._withRetries(function (db) {
                        return _deleteObject(db, key);
                      });
                    case 2:
                      delete _this32.localCache[key];
                      return _context80.abrupt("return", _this32.notifyServiceWorker(key));
                    case 4:
                    case "end":
    ...
    key: "_poll",
    value: function () {
      var _poll2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee82() {
        ...
        return _regeneratorRuntime().wrap(function _callee82$(_context82) {
          while (1) switch (_context82.prev = _context82.next) {
            ...
            case 7:
              ...
              return _context82.abrupt("return", keys);
            case 12:
            case "end":
    ...
    value: function startPolling() {
      var _this33 = this;
      this.stopPolling();
      this.pollTimer = setInterval(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee83() {
        return _regeneratorRuntime().wrap(function _callee83$(_context83) {
          while (1) switch (_context83.prev = _context83.next) {
            case 0:
              return _context83.abrupt("return", _this33._poll());
            case 1:
            case "end":
...
var MockReCaptchaLoaderImpl = /*#__PURE__*/function () {
  ...
  return _createClass(MockReCaptchaLoaderImpl, [{
    key: "load",
    value: function () {
      var _load = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee84(auth) {
        return _regeneratorRuntime().wrap(function _callee84$(_context84) {
          while (1) switch (_context84.prev = _context84.next) {
            case 0:
              return _context84.abrupt("return", new MockReCaptcha(auth));
            case 1:
            case "end":
...
var RecaptchaVerifier = exports.R = /*#__PURE__*/function () {
  ...
  return _createClass(RecaptchaVerifier, [{
    key: "verify",
    value: (function () {
      var _verify2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee85() {
        var _this35 = this;
    ...
    value: function () {
      var _makeRenderPromise = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee86() {
        ...
        return _regeneratorRuntime().wrap(function _callee86$(_context86) {
          while (1) switch (_context86.prev = _context86.next) {
            ...
            case 2:
              ...
              return _context86.abrupt("return", this.widgetId);
            case 4:
            case "end":
    ...
    key: "init",
    value: function () {
      var _init = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee87() {
        var siteKey;
        return _regeneratorRuntime().wrap(function _callee87$(_context87) {
          while (1) switch (_context87.prev = _context87.next) {
            ...
            case 5:
              this.recaptcha = _context87.sent;
              _context87.next = 8;
              return getRecaptchaParams(this.auth);
            case 8:
              siteKey = _context87.sent;
 ...
 * @public
 */
function signInWithPhoneNumber(_x218, _x219, _x220) {
  return _signInWithPhoneNumber.apply(this, arguments);
}
/**
 ...
 */
function _signInWithPhoneNumber() {
  _signInWithPhoneNumber = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee176(auth, phoneNumber, appVerifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee176$(_context176) {
      while (1) switch (_context176.prev = _context176.next) {
        case 0:
          ...
          return _context176.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 2:
          authInternal = _castAuth(auth);
          _context176.next = 5;
          return _verifyPhoneNumber(authInternal, phoneNumber, (0, _util.getModularInstance)(appVerifier));
        case 5:
          verificationId = _context176.sent;
          return _context176.abrupt("return", new ConfirmationResultImpl(verificationId, function (cred) {
...
function linkWithPhoneNumber(_x221, _x222, _x223) {
  return _linkWithPhoneNumber.apply(this, arguments);
}
/**
 ...
 */
function _linkWithPhoneNumber() {
  _linkWithPhoneNumber = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee177(user, phoneNumber, appVerifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee177$(_context177) {
      while (1) switch (_context177.prev = _context177.next) {
        ...
        case 5:
          verificationId = _context177.sent;
          return _context177.abrupt("return", new ConfirmationResultImpl(verificationId, function (cred) {
...
function reauthenticateWithPhoneNumber(_x224, _x225, _x226) {
...
function _reauthenticateWithPhoneNumber() {
  _reauthenticateWithPhoneNumber = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee178(user, phoneNumber, appVerifier) {
    var userInternal, verificationId;
    return _regeneratorRuntime().wrap(function _callee178$(_context178) {
      while (1) switch (_context178.prev = _context178.next) {
        case 0:
          ...
          return _context178.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(userInternal.auth)));
        case 3:
          _context178.next = 5;
          return _verifyPhoneNumber(userInternal.auth, phoneNumber, (0, _util.getModularInstance)(appVerifier));
        case 5:
          verificationId = _context178.sent;
          return _context178.abrupt("return", new ConfirmationResultImpl(verificationId, function (cred) {
...
function _verifyPhoneNumber(_x227, _x228, _x229) {
...
function _verifyPhoneNumber2() {
  _verifyPhoneNumber2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee182(auth, options, verifier) {
      ...
      while (1) switch (_context182.prev = _context182.next) {
        ...
        case 9:
          ...
          startEnrollPhoneMfaActionCallback = /*#__PURE__*/function () {
            var _ref46 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee179(authInstance, request) {
              ...
              return _regeneratorRuntime().wrap(function _callee179$(_context179) {
                while (1) switch (_context179.prev = _context179.next) {
                  ...
                  case 4:
                    requestWithRecaptchaV2 = _context179.sent;
                    return _context179.abrupt("return", startEnrollPhoneMfa(authInstance, requestWithRecaptchaV2));
                  case 6:
                    return _context179.abrupt("return", startEnrollPhoneMfa(authInstance, request));
                  case 7:
                  case "end":
            ...
            return function startEnrollPhoneMfaActionCallback(_x296, _x297) {
        ...
        case 20:
          ...
          return _context182.abrupt("return", response.phoneSessionInfo.sessionInfo);
        case 24:
          ...
          startSignInPhoneMfaActionCallback = /*#__PURE__*/function () {
            var _ref47 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee180(authInstance, request) {
              var requestWithRecaptchaV2;
              return _regeneratorRuntime().wrap(function _callee180$(_context180) {
                while (1) switch (_context180.prev = _context180.next) {
                  case 0:
                    ...
                    return injectRecaptchaV2Token(authInstance, request, verifier);
                  case 4:
                    requestWithRecaptchaV2 = _context180.sent;
                    return _context180.abrupt("return", startSignInPhoneMfa(authInstance, requestWithRecaptchaV2));
                  case 6:
                    return _context180.abrupt("return", startSignInPhoneMfa(authInstance, request));
                  case 7:
                  case "end":
            ...
            return function startSignInPhoneMfaActionCallback(_x298, _x299) {
        ...
        case 32:
          _response = _context182.sent;
          return _context182.abrupt("return", _response.phoneResponseInfo.sessionInfo);
        case 34:
          _context182.next = 43;
          break;
        case 36:
          ...
          sendPhoneVerificationCodeActionCallback = /*#__PURE__*/function () {
            var _ref48 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee181(authInstance, request) {
              var requestWithRecaptchaV2;
              return _regeneratorRuntime().wrap(function _callee181$(_context181) {
                while (1) switch (_context181.prev = _context181.next) {
                  case 0:
                    ...
                    return injectRecaptchaV2Token(authInstance, request, verifier);
                  case 4:
                    requestWithRecaptchaV2 = _context181.sent;
                    return _context181.abrupt("return", sendPhoneVerificationCode(authInstance, requestWithRecaptchaV2));
                  case 6:
                    return _context181.abrupt("return", sendPhoneVerificationCode(authInstance, request));
                  case 7:
                  case "end":
            ...
            return function sendPhoneVerificationCodeActionCallback(_x300, _x301) {
        ...
        case 41:
          _response2 = _context182.sent;
          return _context182.abrupt("return", _response2.sessionInfo);
        case 43:
          _context182.prev = 43;
          verifier === null || verifier === void 0 ? void 0 : verifier._reset();
          return _context182.finish(43);
        case 46:
        case "end":
          return _context182.stop();
      }
    }, _callee182, null, [[1, 6], [9,, 43, 46]]);
  }));
  return _verifyPhoneNumber2.apply(this, arguments);
}
function updatePhoneNumber(_x230, _x231) {
...
function _updatePhoneNumber() {
  _updatePhoneNumber = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee183(user, credential) {
    var userInternal;
    return _regeneratorRuntime().wrap(function _callee183$(_context183) {
      while (1) switch (_context183.prev = _context183.next) {
        case 0:
          ...
          return _context183.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(userInternal.auth)));
        case 3:
          _context183.next = 5;
...
function injectRecaptchaV2Token(_x232, _x233, _x234) {
...
function _injectRecaptchaV2Token() {
  _injectRecaptchaV2Token = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee184(auth, request, recaptchaV2Verifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee184$(_context184) {
      while (1) switch (_context184.prev = _context184.next) {
        ...
        case 3:
          recaptchaV2Token = _context184.sent;
          ...
          return _context184.abrupt("return", newRequest);
        case 15:
...
var PhoneAuthProvider = exports.P = /*#__PURE__*/function () {
  ...
  return _createClass(PhoneAuthProvider, [{
    ...
    key: "credentialFromTaggedObject",
    value: function credentialFromTaggedObject(_ref32) {
      var tokenResponse = _ref32._tokenResponse;
      if (!tokenResponse) {
        return null;
      }
...
var IdpCredential = /*#__PURE__*/function (_AuthCredential5) {
  function IdpCredential(params) {
    ...
    _this39 = _callSuper(this, IdpCredential, ["custom" /* ProviderId.CUSTOM */, "custom" /* ProviderId.CUSTOM */]);
 ...
 */
function _link2() {
  _link2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee185(params) {
    var auth, user;
    return _regeneratorRuntime().wrap(function _callee185$(_context185) {
      while (1) switch (_context185.prev = _context185.next) {
        case 0:
          ...
          _assert(user, auth, "internal-error" /* AuthErrorCode.INTERNAL_ERROR */);
          return _context185.abrupt("return", _link$1(user, new IdpCredential(params), params.bypassAuthState));
        case 3:
        case "end":
  ...
  return _createClass(AbstractPopupRedirectOperation, [{
    ...
    value: function execute() {
      ...
      return new Promise(/*#__PURE__*/function () {
        var _ref33 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee88(resolve, reject) {
          return _regeneratorRuntime().wrap(function _callee88$(_context88) {
            while (1) switch (_context88.prev = _context88.next) {
              case 0:
                ...
                _context88.prev = 1;
                _context88.next = 4;
                return _this40.resolver._initialize(_this40.auth);
              case 4:
                _this40.eventManager = _context88.sent;
                _context88.next = 7;
                return _this40.onExecution();
              case 7:
    ...
    key: "onAuthEvent",
    value: function () {
      var _onAuthEvent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee89(event) {
        ...
        return _regeneratorRuntime().wrap(function _callee89$(_context89) {
          while (1) switch (_context89.prev = _context89.next) {
            ...
            case 9:
              ...
              _context89.t0.resolve.call(_context89.t0, _context89.t1);
              _context89.next = 16;
              break;
            case 13:
              _context89.prev = 13;
              _context89.t2 = _context89["catch"](5);
              this.reject(_context89.t2);
            case 16:
            case "end":
 ...
 * @public
 */
function signInWithPopup(_x239, _x240, _x241) {
...
function _signInWithPopup() {
  _signInWithPopup = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee186(auth, provider, resolver) {
    ...
    return _regeneratorRuntime().wrap(function _callee186$(_context186) {
      while (1) switch (_context186.prev = _context186.next) {
        case 0:
          ...
          return _context186.abrupt("return", Promise.reject(_createError(auth, "operation-not-supported-in-this-environment" /* AuthErrorCode.OPERATION_NOT_SUPPORTED */)));
        case 2:
          authInternal = _castAuth(auth);
          ...
          return _context186.abrupt("return", action.executeNotNull());
        case 7:
        case "end":
...
function reauthenticateWithPopup(_x242, _x243, _x244) {
...
function _reauthenticateWithPopup() {
  _reauthenticateWithPopup = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee187(user, provider, resolver) {
    ...
    return _regeneratorRuntime().wrap(function _callee187$(_context187) {
      while (1) switch (_context187.prev = _context187.next) {
        case 0:
          ...
          return _context187.abrupt("return", Promise.reject(_createError(userInternal.auth, "operation-not-supported-in-this-environment" /* AuthErrorCode.OPERATION_NOT_SUPPORTED */)));
        case 3:
          ...
          return _context187.abrupt("return", action.executeNotNull());
        case 7:
        case "end":
...
function linkWithPopup(_x245, _x246, _x247) {
...
function _linkWithPopup() {
  _linkWithPopup = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee188(user, provider, resolver) {
    var userInternal, resolverInternal, action;
    return _regeneratorRuntime().wrap(function _callee188$(_context188) {
      while (1) switch (_context188.prev = _context188.next) {
        case 0:
          ...
          return _context188.abrupt("return", action.executeNotNull());
        case 5:
        case "end":
...
var PopupOperation = /*#__PURE__*/function (_AbstractPopupRedirec) {
  ...
  return _createClass(PopupOperation, [{
    key: "executeNotNull",
    value: function () {
      var _executeNotNull = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee90() {
        var result;
    ...
    key: "onExecution",
    value: function () {
      var _onExecution = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee91() {
        var _this42 = this;
        var eventId;
        return _regeneratorRuntime().wrap(function _callee91$(_context91) {
          while (1) switch (_context91.prev = _context91.next) {
            case 0:
              ...
              eventId);
            case 4:
              this.authWindow = _context91.sent;
              ...
              this.resolver._isIframeWebStorageSupported(this.auth, function (isSupported) {
                if (!isSupported) {
                  _this42.reject(_createError(_this42.auth, "web-storage-unsupported" /* AuthErrorCode.WEB_STORAGE_UNSUPPORTED */));
                }
              });
      ...
      var _poll3 = function poll() {
        ...
        if ((_b = (_a = _this43.authWindow) === null || _a === void 0 ? void 0 : _a.window) === null || _b === void 0 ? void 0 : _b.closed) {
          ...
          _this43.pollId = window.setTimeout(function () {
            _this43.pollId = null;
            _this43.reject(_createError(_this43.auth, "popup-closed-by-user" /* AuthErrorCode.POPUP_CLOSED_BY_USER */));
...
var RedirectAction = /*#__PURE__*/function (_AbstractPopupRedirec2) {
  function RedirectAction(auth, resolver) {
    ...
    _this44 = _callSuper(this, RedirectAction, [auth, ["signInViaRedirect" /* AuthEventType.SIGN_IN_VIA_REDIRECT */, "linkViaRedirect" /* AuthEventType.LINK_VIA_REDIRECT */, "reauthViaRedirect" /* AuthEventType.REAUTH_VIA_REDIRECT */, "unknown" /* AuthEventType.UNKNOWN */], resolver, undefined, bypassAuthState]);
  ...
  return _createClass(RedirectAction, [{
    key: "execute",
    value: (function () {
      var _execute2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee92() {
        ...
        return _regeneratorRuntime().wrap(function _callee92$(_context92) {
          while (1) switch (_context92.prev = _context92.next) {
            ...
            case 5:
              hasPendingRedirect = _context92.sent;
            ...
            case 17:
              _context92.prev = 17;
              _context92.t1 = _context92["catch"](2);
              readyOutcome = function readyOutcome() {
                return Promise.reject(_context92.t1);
              };
            case 20:
            ...
            case 21:
              ...
              return _context92.abrupt("return", readyOutcome());
            case 23:
            case "end":
    ...
    key: "onAuthEvent",
    value: function () {
      var _onAuthEvent2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee93(event) {
        var user;
        return _regeneratorRuntime().wrap(function _callee93$(_context93) {
          while (1) switch (_context93.prev = _context93.next) {
            case 0:
              ...
              return _context93.abrupt("return", _superPropGet(RedirectAction, "onAuthEvent", this, 3)([event]));
            case 4:
    ...
    key: "onExecution",
    value: function () {
      var _onExecution2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee94() {
...
function _getAndClearPendingRedirectStatus(_x249, _x250) {
  return _getAndClearPendingRedirectStatus2.apply(this, arguments);
}
function _getAndClearPendingRedirectStatus2() {
  _getAndClearPendingRedirectStatus2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee189(resolver, auth) {
    ...
    return _regeneratorRuntime().wrap(function _callee189$(_context189) {
      while (1) switch (_context189.prev = _context189.next) {
        ...
        case 4:
          ...
          return _context189.abrupt("return", false);
        case 6:
          _context189.next = 8;
          return persistence._get(key);
        case 8:
          _context189.t0 = _context189.sent;
          hasPendingRedirect = _context189.t0 === 'true';
          _context189.next = 12;
          return persistence._remove(key);
        case 12:
          return _context189.abrupt("return", hasPendingRedirect);
        case 13:
        case "end":
...
function _setPendingRedirectStatus(_x251, _x252) {
  return _setPendingRedirectStatus2.apply(this, arguments);
}
function _setPendingRedirectStatus2() {
  _setPendingRedirectStatus2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee190(resolver, auth) {
    return _regeneratorRuntime().wrap(function _callee190$(_context190) {
      while (1) switch (_context190.prev = _context190.next) {
        case 0:
          return _context190.abrupt("return", resolverPersistence(resolver)._set(pendingRedirectKey(auth), 'true'));
        case 1:
        case "end":
...
function _signInWithRedirect(_x253, _x254, _x255) {
...
function _signInWithRedirect2() {
  _signInWithRedirect2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee191(auth, provider, resolver) {
    ...
    return _regeneratorRuntime().wrap(function _callee191$(_context191) {
      while (1) switch (_context191.prev = _context191.next) {
        case 0:
          ...
          return _context191.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 2:
          authInternal = _castAuth(auth);
          _assertInstanceOf(auth, provider, FederatedAuthProvider);
        ...
        case 9:
          return _context191.abrupt("return", resolverInternal._openRedirect(authInternal, provider, "signInViaRedirect" /* AuthEventType.SIGN_IN_VIA_REDIRECT */));
        case 10:
        case "end":
...
function _reauthenticateWithRedirect(_x256, _x257, _x258) {
...
function _reauthenticateWithRedirect2() {
  _reauthenticateWithRedirect2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee192(user, provider, resolver) {
    ...
    return _regeneratorRuntime().wrap(function _callee192$(_context192) {
      while (1) switch (_context192.prev = _context192.next) {
        case 0:
          ...
          return _context192.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(userInternal.auth)));
        case 4:
          _context192.next = 6;
        ...
        case 11:
          eventId = _context192.sent;
          return _context192.abrupt("return", resolverInternal._openRedirect(userInternal.auth, provider, "reauthViaRedirect" /* AuthEventType.REAUTH_VIA_REDIRECT */, eventId));
        case 13:
        case "end":
...
function _linkWithRedirect(_x259, _x260, _x261) {
...
function _linkWithRedirect2() {
  _linkWithRedirect2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee193(user, provider, resolver) {
    var userInternal, resolverInternal, eventId;
    return _regeneratorRuntime().wrap(function _callee193$(_context193) {
      while (1) switch (_context193.prev = _context193.next) {
        ...
        case 9:
          ...
          return prepareUserForRedirect(userInternal);
        case 11:
          eventId = _context193.sent;
          return _context193.abrupt("return", resolverInternal._openRedirect(userInternal.auth, provider, "linkViaRedirect" /* AuthEventType.LINK_VIA_REDIRECT */, eventId));
        case 13:
        case "end":
...
function getRedirectResult(_x262, _x263) {
  return _getRedirectResult2.apply(this, arguments);
}
function _getRedirectResult2() {
  _getRedirectResult2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee194(auth, resolver) {
    return _regeneratorRuntime().wrap(function _callee194$(_context194) {
      while (1) switch (_context194.prev = _context194.next) {
        ...
        case 2:
          return _context194.abrupt("return", _getRedirectResult(auth, resolver, false));
        case 3:
        case "end":
...
function _getRedirectResult(_x264, _x265) {
  return _getRedirectResult3.apply(this, arguments);
}
function _getRedirectResult3() {
  _getRedirectResult3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee195(auth, resolverExtern) {
    var bypassAuthState,
      authInternal,
      resolver,
      action,
    ...
    return _regeneratorRuntime().wrap(function _callee195$(_context195) {
      while (1) switch (_context195.prev = _context195.next) {
        case 0:
          bypassAuthState = _args195.length > 2 && _args195[2] !== undefined ? _args195[2] : false;
          if (!(0, _app._isFirebaseServerApp)(auth.app)) {
            _context195.next = 3;
            break;
          }
          return _context195.abrupt("return", Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth)));
        case 3:
          authInternal = _castAuth(auth);
        ...
        case 15:
          return _context195.abrupt("return", result);
        case 16:
        case "end":
...
function prepareUserForRedirect(_x266) {
...
function _prepareUserForRedirect() {
  _prepareUserForRedirect = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee196(user) {
    var eventId;
    return _regeneratorRuntime().wrap(function _callee196$(_context196) {
      while (1) switch (_context196.prev = _context196.next) {
        ...
        case 6:
          return _context196.abrupt("return", eventId);
        case 7:
        case "end":
...
var AuthEventManager = exports.aD = /*#__PURE__*/function () {
...
function isNullRedirectEvent(_ref34) {
 ...
 * limitations under the License.
 */
function _getProjectConfig(_x267) {
...
function _getProjectConfig2() {
  _getProjectConfig2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee197(auth) {
    var request,
      _args197 = arguments;
    return _regeneratorRuntime().wrap(function _callee197$(_context197) {
      while (1) switch (_context197.prev = _context197.next) {
        case 0:
          request = _args197.length > 1 && _args197[1] !== undefined ? _args197[1] : {};
          return _context197.abrupt("return", _performApiRequest(auth, "GET" /* HttpMethod.GET */, "/v1/projects" /* Endpoint.GET_PROJECT_CONFIG */, request));
        case 2:
        case "end":
...
function _validateOrigin(_x268) {
  return _validateOrigin2.apply(this, arguments);
}
function _validateOrigin2() {
  _validateOrigin2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee198(auth) {
    ...
    return _regeneratorRuntime().wrap(function _callee198$(_context198) {
      while (1) switch (_context198.prev = _context198.next) {
        ...
        case 4:
          _yield$_getProjectCon = _context198.sent;
        ...
        case 16:
          _context198.prev = 16;
          _context198.t0 = _context198["catch"](11);
        case 18:
          _context198.next = 9;
          break;
        case 20:
        ...
        case 22:
          ...
          _iterator6.e(_context198.t1);
        case 25:
          _context198.prev = 25;
          _iterator6.f();
          return _context198.finish(25);
        case 28:
    ...
    }, _callee198, null, [[7, 22, 25, 28], [11, 16]]);
  }));
  return _validateOrigin2.apply(this, arguments);
}
...
function _openIframe2() {
  _openIframe2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee200(auth) {
    var context, gapi;
    return _regeneratorRuntime().wrap(function _callee200$(_context200) {
      while (1) switch (_context200.prev = _context200.next) {
        ...
        case 2:
          context = _context200.sent;
          gapi = _window().gapi;
          _assert(gapi, auth, "internal-error" /* AuthErrorCode.INTERNAL_ERROR */);
          return _context200.abrupt("return", context.open({
            where: document.body,
            ...
            return new Promise(/*#__PURE__*/function () {
              var _ref49 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee199(resolve, reject) {
...
var AuthPopup = exports.aO = /*#__PURE__*/function () {
...
function _open(auth, url, name) {
  ...
  var optionsString = Object.entries(options).reduce(function (accum, _ref35) {
...
function _getRedirectUrl(_x270, _x271, _x272, _x273, _x274, _x275) {
  return _getRedirectUrl2.apply(this, arguments);
}
function _getRedirectUrl2() {
  _getRedirectUrl2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee201(auth, provider, authType, redirectUrl, eventId, additionalParams) {
    ...
    return _regeneratorRuntime().wrap(function _callee201$(_context201) {
      while (1) switch (_context201.prev = _context201.next) {
        ...
        case 10:
          appCheckToken = _context201.sent;
          ...
          return _context201.abrupt("return", "".concat(getHandlerBase(auth), "?").concat((0, _util.querystring)(paramsDict).slice(1)).concat(appCheckTokenFragment));
        case 13:
        case "end":
...
function getHandlerBase(_ref37) {
...
var BrowserPopupRedirectResolver = /*#__PURE__*/function () {
  ...
  return _createClass(BrowserPopupRedirectResolver, [{
    key: "_openPopup",
    value: function () {
      var _openPopup2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee95(auth, provider, authType, eventId) {
        var _a, url;
        return _regeneratorRuntime().wrap(function _callee95$(_context95) {
          while (1) switch (_context95.prev = _context95.next) {
            ...
            case 3:
              url = _context95.sent;
              return _context95.abrupt("return", _open(auth, url, _generateEventId()));
            case 5:
            case "end":
      ...
      function _openPopup(_x276, _x277, _x278, _x279) {
    ...
    key: "_openRedirect",
    value: function () {
      var _openRedirect2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee96(auth, provider, authType, eventId) {
        var url;
      ...
      function _openRedirect(_x280, _x281, _x282, _x283) {
    ...
    value: function () {
      var _initAndGetManager = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee97(auth) {
        var iframe, manager;
        return _regeneratorRuntime().wrap(function _callee97$(_context97) {
          while (1) switch (_context97.prev = _context97.next) {
            ...
            case 2:
              ...
              return _context97.abrupt("return", manager);
            case 8:
            case "end":
      ...
      function initAndGetManager(_x284) {
 ...
 * @public
 */
var browserPopupRedirectResolver = exports.k = BrowserPopupRedirectResolver;
...
var PhoneMultiFactorAssertionImpl = /*#__PURE__*/function (_MultiFactorAssertion) {
  function PhoneMultiFactorAssertionImpl(credential) {
    ...
    _this47 = _callSuper(this, PhoneMultiFactorAssertionImpl, ["phone" /* FactorId.PHONE */]);
 ...
 * @public
 */
var PhoneMultiFactorGenerator = exports.m = /*#__PURE__*/function () {
...
var TotpMultiFactorGenerator = exports.T = /*#__PURE__*/function () {
  ...
  return _createClass(TotpMultiFactorGenerator, null, [{
    ...
    key: "generateSecret",
    value: (function () {
      var _generateSecret = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee98(session) {
        ...
        return _regeneratorRuntime().wrap(function _callee98$(_context98) {
          while (1) switch (_context98.prev = _context98.next) {
            ...
            case 4:
              ...
              return _context98.abrupt("return", TotpSecret._fromStartTotpMfaEnrollmentResponse(response, mfaSession.user.auth));
            case 6:
            case "end":
...
var TotpMultiFactorAssertionImpl = /*#__PURE__*/function (_MultiFactorAssertion2) {
  function TotpMultiFactorAssertionImpl(otp, enrollmentId, secret) {
    ...
    _this48 = _callSuper(this, TotpMultiFactorAssertionImpl, ["totp" /* FactorId.TOTP */]);
    _this48.otp = otp;
  ...
  return _createClass(TotpMultiFactorAssertionImpl, [{
    key: "_finalizeEnroll",
    value: (/** @internal */function () {
      var _finalizeEnroll2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee99(auth, idToken, displayName) {
        return _regeneratorRuntime().wrap(function _callee99$(_context99) {
          while (1) switch (_context99.prev = _context99.next) {
            case 0:
              _assert(typeof this.secret !== 'undefined', auth, "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */);
              return _context99.abrupt("return", finalizeEnrollTotpMfa(auth, {
                idToken: idToken,
                displayName: displayName,
      ...
      function _finalizeEnroll(_x286, _x287, _x288) {
    ...
    key: "_finalizeSignIn",
    value: (function () {
      var _finalizeSignIn2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee100(auth, mfaPendingCredential) {
        ...
        return _regeneratorRuntime().wrap(function _callee100$(_context100) {
          while (1) switch (_context100.prev = _context100.next) {
            case 0:
              ...
              return _context100.abrupt("return", finalizeSignInTotpMfa(auth, {
                mfaPendingCredential: mfaPendingCredential,
      ...
      function _finalizeSignIn(_x289, _x290) {
 ...
 * @public
 */
var TotpSecret = exports.n = /*#__PURE__*/function () {
...
var AuthInterop = /*#__PURE__*/function () {
  ...
  return _createClass(AuthInterop, [{
    ...
    key: "getToken",
    value: function () {
      var _getToken2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee101(forceRefresh) {
        var accessToken;
...
function registerAuth(clientPlatform) {
  (0, _app._registerComponent)(new _component.Component("auth" /* _ComponentName.AUTH */, function (container, _ref38) {
    var deps = _ref38.options;
...
var mintCookieFactory = function mintCookieFactory(url) {
  return /*#__PURE__*/function () {
    var _ref39 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee102(user) {
...
Object.defineProperty(exports, "TwitterAuthProvider", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.$;
  }
});
Object.defineProperty(exports, "applyActionCode", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.a7;
  }
});
...
Object.defineProperty(exports, "isSignInWithEmailLink", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.ad;
  }
});
Object.defineProperty(exports, "linkWithCredential", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.a2;
  }
});
...
Object.defineProperty(exports, "updateEmail", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.al;
  }
});
Object.defineProperty(exports, "updatePassword", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.am;
  }
});
...
Object.defineProperty(exports, "verifyBeforeUpdateEmail", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.ah;
  }
});
Object.defineProperty(exports, "verifyPasswordResetCode", {
  enumerable: true,
  get: function () {
    return _indexDfc2d82f.a9;
  }
});
var _indexDfc2d82f = require("./index-dfc2d82f.js");
require("@firebase/app");
require("@firebase/util");
require("@firebase/logger");
require("tslib");
require("@firebase/component");
},{"./index-dfc2d82f.js":"../node_modules/@firebase/auth/dist/esm2017/index-dfc2d82f.js","@firebase/app":"../node_modules/@firebase/app/dist/esm/index.esm2017.js","@firebase/util":"../node_modules/@firebase/util/dist/index.esm2017.js","@firebase/logger":"../node_modules/@firebase/logger/dist/esm/index.esm2017.js","tslib":"../node_modules/tslib/tslib.es6.js","@firebase/component":"../node_modules/@firebase/component/dist/esm/index.esm2017.js"}],"../node_modules/firebase/auth/dist/esm/index.esm.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/auth":"../node_modules/@firebase/auth/dist/esm2017/index.js"}],"src/firebase-config.js":[function(require,module,exports) {
"use strict";
...
},{"firebase/app":"../node_modules/firebase/app/dist/esm/index.esm.js","firebase/auth":"../node_modules/firebase/auth/dist/esm/index.esm.js"}],"src/services/apiHandler.js":[function(require,module,exports) {
"use strict";
...
var app = (0, _app.initializeApp)(firebaseConfig);
var auth = exports.auth = (0, _auth.getAuth)(app);
},{"firebase/app":"../node_modules/firebase/app/dist/esm/index.esm.js","firebase/auth":"../node_modules/firebase/auth/dist/esm/index.esm.js"}],"src/shoppingList.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loadShoppingList = exports.clearShoppingList = exports.addToShoppingList = void 0;
// shoppingList.js
var shoppingListContainer = document.getElementById("shopping-list");

// Load shopping list from localStorage
var loadShoppingList = exports.loadShoppingList = function loadShoppingList() {
  var shoppingList = JSON.parse(localStorage.getItem("shoppingList")) || [];
  displayShoppingList(shoppingList);
};

// Display shopping list in the UI
var displayShoppingList = function displayShoppingList(list) {
...
var addToShoppingList = exports.addToShoppingList = function addToShoppingList(ingredient) {
  var shoppingList = JSON.parse(localStorage.getItem("shoppingList")) || [];
...
// Expose methods
},{}],"src/preferencesFilter.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateMealPlans = exports.togglePreference = void 0;
...
var togglePreference = exports.togglePreference = function togglePreference(preference) {
  filterOptions[preference] = !filterOptions[preference];
  updateMealPlans();
};

// Update meal plans based on selected filters
var updateMealPlans = exports.updateMealPlans = function updateMealPlans() {
  // Fetch meal plans and apply filters
  var meals = JSON.parse(localStorage.getItem("mealPlans")) || [];
...
var _auth = require("firebase/auth");
var _apiHandler = require("./services/apiHandler.js");
var _shoppingList = require("./shoppingList.js");
var _preferencesFilter = require("./preferencesFilter.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import Firebase Authentication methods
...
var generateMealPlanBtn = document.getElementById("generate-meal-plan");
var mealResults = document.getElementById("meal-results");
var veganFilter = document.getElementById("vegan-filter");
var lowCarbFilter = document.getElementById("low-carb-filter");

// Firebase Authentication Functions
signupBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var userCredential;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.prev = 0;
        _context.next = 3;
        return (0, _auth.createUserWithEmailAndPassword)(_firebaseConfig.auth, emailInput.value, passwordInput.value);
      case 3:
        userCredential = _context.sent;
        alert("Welcome, ".concat(userCredential.user.email));
        _context.next = 10;
        break;
      case 7:
        _context.prev = 7;
...
loginBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var userCredential;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.prev = 0;
        _context2.next = 3;
        return (0, _auth.signInWithEmailAndPassword)(_firebaseConfig.auth, emailInput.value, passwordInput.value);
      case 3:
        userCredential = _context2.sent;
        alert("Welcome back, ".concat(userCredential.user.email));
        _context2.next = 10;
        break;
      case 7:
        _context2.prev = 7;
...
logoutBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      case 0:
        _context3.next = 2;
...
(0, _auth.onAuthStateChanged)(_firebaseConfig.auth, function (user) {
  if (user) {
    console.log("User logged in: ".concat(user.email));
...
generateMealPlanBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
  var mealData;
  return _regeneratorRuntime().wrap(function _callee4$(_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      case 0:
        _context4.next = 2;
        return (0, _apiHandler.fetchMealPlans)();
      case 2:
...
// Display Meals
var displayMeals = function displayMeals(meals) {
  mealResults.innerHTML = ""; // Clear previous results

  meals.forEach(function (meal) {
    var mealCard = document.createElement("div");
    mealCard.classList.add("meal-card");
    mealCard.innerHTML = "\n            <h3>".concat(meal.title, "</h3>\n            <img src=\"").concat(meal.image, "\" alt=\"").concat(meal.title, "\">\n            <p>Ready in ").concat(meal.readyInMinutes, " minutes</p>\n            <button class=\"save-to-list\" data-ingredients=\"").concat(meal.extendedIngredients.map(function (i) {
      return i.name;
    }).join(', '), "\">Save Ingredients</button>\n        ");
    var saveButton = mealCard.querySelector(".save-to-list");
    saveButton.addEventListener("click", function () {
      var ingredients = saveButton.getAttribute("data-ingredients").split(", ");
      ingredients.forEach(function (ingredient) {
        return (0, _shoppingList.addToShoppingList)(ingredient);
      });
    });
...
veganFilter.addEventListener("change", function () {
  (0, _preferencesFilter.togglePreference)("vegan");
});
lowCarbFilter.addEventListener("change", function () {
  (0, _preferencesFilter.togglePreference)("lowCarb");
});
},{"firebase/app":"../node_modules/firebase/app/dist/esm/index.esm.js","./firebase-config.js":"src/firebase-config.js","firebase/auth":"../node_modules/firebase/auth/dist/esm/index.esm.js","./services/apiHandler.js":"src/services/apiHandler.js","./shoppingList.js":"src/shoppingList.js","./preferencesFilter.js":"src/preferencesFilter.js"}],"../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
